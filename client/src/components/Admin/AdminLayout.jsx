    ...
    <>
      <div className="min-h-screen flex flex-col md:flex-row relative">
        ...
        <div className="flex md:hidden p-4 bg-gray-900 text-white z-20">
          ...
          <h1 className="ml-4 text-xl text-gray-300 font-medium">Admin Dashbord</h1>
        </div>

        {/* Overlay for Mobile Sidebar */}
        {isSidebarOpen && (
          <div onClick={toggleSidebar} className="fixed inset-0 z-10 bg-black opacity-50 md:hidden">
          </div>
        )}
